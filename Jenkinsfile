    ...
    stage('Tag Distributable') {
      ...
      steps {
        ...
        withCredentials([string(credentialsId: 'github-api-token', variable: 'TOKEN')]) {
          sh 'git push https://adi-ia-jenkins:$TOKEN@github.com/myuw-web-components/myuw-banner.git --tags'
          sh 'git checkout -B gh-pages'
          sh 'git push https://adi-ia-jenkins:$TOKEN@github.com/myuw-web-components/myuw-banner.git gh-pages --force'
        }
      }
    }
